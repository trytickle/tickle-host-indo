<template>
  <div class="sidebar">
    ...
    <div class="div-block-3">
      ...
      <button class="sidebar-link" :class="{'is-active': $store.state.activePage === 'StepPhotos', 'is-completed': $store.state.photos[0] !== null}" id="StepPhotos" @click="changeStep($event)">{{ $t("photo") }}<span v-if="$store.state.photos[0] !== null"> 👍</span></button>
