<template>
  <div class="menu-button" :style="isMenu ? 'margin-top:30px;text-align:left;height:50px;' : 'position:fixed;top:30px;right:0;height:40px;'">
    <button class="text-block link" :style="isMenu ? '' : 'color:rgba(0,0,0,0.7);'" style="background-color:rgba(0,0,0,0);margin:0;"><i class="fas fa-comment" style="font-size:12px;margin-right:10px;"></i>{{ language }}</button>
